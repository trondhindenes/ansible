...
class Connection(ConnectionBase):
    ...
    def __init__(self,  *args, **kwargs):
        ...
        self.shell_id         = None
        self.delegate         = None
        self._shell_type      = 'powershell_containers'
    ...
    def set_host_overrides(self, host, hostvars=None):
        ...
        self._containerid = hostvars.get('containerid', None)
    ...
    def exec_command(self, cmd, in_data=None, sudoable=True):
        ...
        last_part = len(cmd_parts) -1
        cont_decoded_cmd = base64.b64decode(cmd_parts[last_part]).decode('utf-16-le')
        #container_id = '62fcc2dd1951862f562cba44b7830a7fac73eeb2b0d7192c58d3a467e902143f'
        cont_decoded_cmd = cont_decoded_cmd.replace('<<<CONTAINERID>>>', str(self._containerid))
        cmd_parts[last_part] = base64.b64encode(cont_decoded_cmd.encode('utf-16-le'))
        


        try:
            display.vvv("TRONDDBG execfile %s" % cmd_parts, host=self._winrm_host)
            #epdb.st()
